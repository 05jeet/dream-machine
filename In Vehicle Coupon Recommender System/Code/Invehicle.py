...
df
# Bsst model is SVM with 75.73% accoracy.

# Classification Report
#checking for test dataset
SVM = SVC(kernel="rbf", random_state=None, probability=True, cache_size=20, gamma=0.1).fit(X_train, y_train)
y_val_SVM = SVM.predict(X_test)
print(classification_report(y_test, y_val_SVM))

# Confusion matrix
from sklearn.metrics import confusion_matrix
Conf_SVM = confusion_matrix(y_test,y_val_SVM)
print(Conf_SVM)
############################